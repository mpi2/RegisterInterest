...
INSERT INTO gene
  ...
  ('MGI:1919199',     'Cers5',     'c-010',      @PAPP,             @now,                   @PK_PAPP,             @PAPP,                'caps-010',                            @MP,                                  @PK_MP,                                   @MP,                                     @nowplus1,                                  @nowplus2,                                'naps-010',                     @MP,                           @PK_MP,                            @MP,                              @nowplus3,                          @nowplus4,                         'ps-010',           @PDA,               @nowplus5,               @PK_PDA,               @PDA,                  0,                                @now),
  ('MGI:103576',      'Ccl11',     'c-020',      @W,                @now,                   @PK_W,                @W,                   'caps-020',                            NULL,                                 NULL,                                     NULL,                                    @nowplus1,                                  @nowplus2,                                'naps-020',                     NULL,                          NULL,                              NULL,                             @nowplus3,                          @nowplus4,                         'ps-020',           @PK_xx,             @nowplus5,               NULL,                  NULL,                  0,                                @now),
  ('MGI:2444824',     'Sirpb1a',   'c-030',      NULL,              @now,                   NULL,                 NULL,                 'caps-030',                            NULL,                                 NULL,                                     NULL,                                    @nowplus1,                                  @nowplus2,                                'naps-030',                     @MP,                           @PK_MP,                            @MP,                              @nowplus3,                          @nowplus4,                         'ps-030',           @PK_xx,             @nowplus5,               NULL,                  NULL,                  0,                                @now),
  ('MGI:2443658',     'Prr14l',    'c-040',      @PAPP,             @now,                   @PK_PAPP,             @PAPP,                'caps-040',                            NULL,                                 NULL,                                     NULL,                                    @nowplus1,                                  @nowplus2,                                'naps-040',                     @MPS,                          @PK_MPS,                           @MPS,                             @nowplus3,                          @nowplus4,                         'ps-040',           @PK_xx,             @nowplus5,               NULL,                  NULL,                  0,                                @now),
