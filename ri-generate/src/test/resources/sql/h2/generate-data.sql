...
INSERT INTO gene
  ...
  ('MGI:0000010',     'gene-010',  'c-010',      @NP,               @now,                   @PK_NP,               'caps-010',                            @MP,                                  @nowplus1,                                 @PK_MP,                                   'naps-010',                     @MP,                           @nowplus2,                          @PK_MP,                            'ps-010',           @PK_xx,             @nowplus3,               @PK_PDA,               0,                                @now),
  ('MGI:0000020',     'gene-020',  'c-020',      @W,                @now,                   @PK_W,                'caps-020',                            @MP,                                  @nowplus1,                                 @PK_MP,                                   'naps-020',                     @MP,                           @nowplus2,                          @PK_MP,                            'ps-020',           @PK_xx,             @nowplus3,               @PK_PDA,               1,                                @now),
  ...
  ('MGI:0000060',     'gene-060',  'c-060',      @PAPP,             @now,                   @PK_PAPP,             'caps-060',                            null,                                 @nowplus1,                                 NULL,                                     'naps-060',                     @MPS,                          @nowplus2,                          @PK_MPS,                           'ps-060',           @PK_xx,             @nowplus3,               @PK_PDA,               5,                                @now),
  ('MGI:0000070',     'gene-070',  'c-070',      @PAPP,             @now,                   @PK_PAPP,             'caps-070',                            null,                                 @nowplus1,                                 NULL,                                     'naps-070',                     @MP,                           @nowplus2,                          @PK_MP,                            'ps-070',           @PK_xx,             @nowplus3,               @PK_MPDA,              6,                                @now),
  ('MGI:0000080',     'gene-080',  'c-080',      @PAPP,             @now,                   @PK_PAPP,             'caps-080',                            @MP,                                  @nowplus1,                                 @PK_MP,                                   'naps-080',                     @MPS,                          @nowplus2,                          @PK_MPS,                           'ps-080',           @PK_xx,             @nowplus3,               NULL,                  7,                                @now),
  ('MGI:0000090',     'gene-090',  'c-090',      @PAPP,             @now,                   @PK_PAPP,             'caps-090',                            @MPS,                                 @nowplus1,                                 @PK_MPS,                                  'naps-090',                     @MP,                           @nowplus2,                          @PK_MP,                            'ps-090',           @PK_xx,             @nowplus3,               NULL,                  8,                                @now),
  ('MGI:0000100',     'gene-100',  'c-100',      @PAPP,             @now,                   @PK_PAPP,             'caps-100',                            @MP,                                  @nowplus1,                                 @PK_MP,                                   'naps-100',                     @MPS,                          @nowplus2,                          @PK_MPS,                           'ps-100',           @PK_xx,             @nowplus3,               @PK_PDA,               9,                                @now),
  ('MGI:0000110',     'gene-110',  'c-110',      @PAPP,             @now,                   @PK_PAPP,             'caps-110',                            @MPS,                                 @nowplus1,                                 @PK_MPS,                                  'naps-110',                     @MP,                           @nowplus2,                          @PK_MP,                            'ps-110',           @PK_xx,             @nowplus3,               @PK_PDA,              10,                                @now),
  ('MGI:0000120',     'gene-120',  'c-120',      @PAPP,             @now,                   @PK_PAPP,             'caps-120',                            @MPS,                                 @nowplus1,                                 @PK_MPS,                                  'naps-120',                     @MP,                           @nowplus2,                          @PK_MP,                            'ps-120',           @PK_xx,             @nowplus3,               @PK_PDA,              11,                                @now)
;
