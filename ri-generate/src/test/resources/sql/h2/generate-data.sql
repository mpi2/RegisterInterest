...
INSERT INTO gene
  ...
  ('MGI:0000010',     'gene-010', 'c-01',        @NP,               @now,                   @PK_NP,              'caps-01',                              @MP,                                  @nowplus1,                                 @PK_MP,                                  'naps-01',                       @MP,                           @nowplus2,                          @PK_MP,                           'ps-01',             @PK_xx,             @nowplus3,               @PK_PDA,               0,                                @now),
  ('MGI:0000020',     'gene-020', 'c-02',        @W,                @now,                   @PK_W,               'caps-02',                              @MP,                                  @nowplus1,                                 @PK_MP,                                  'naps-02',                       @MP,                           @nowplus2,                          @PK_MP,                           'ps-02',             @PK_xx,             @nowplus3,               @PK_PDA,               1,                                @now),
  ...
  ('MGI:0000040',     'gene-040', 'c-04',        @PAPP,             @now,                   @PK_PAPP,            'caps-04',                              @MPS,                                 @nowplus1,                                 @PK_MPS,                                 'naps-04',                       NULL,                          @nowplus2,                          NULL,                             'ps-04',             @PK_xx,             @nowplus3,               NULL,                  3,                                @now),
  ('MGI:0000050',     'gene-050', 'c-05',        @PAPP,             @now,                   @PK_PAPP,            'caps-05',                              @MP,                                  @nowplus1,                                 @PK_MP,                                  'naps-05',                       NULL,                          @nowplus2,                          NULL,                             'ps-05',             @PK_xx,             @nowplus3,               NULL,                  4,                                @now),
  ('MGI:0000060',     'gene-060', 'c-06',        @PAPP,             @now,                   @PK_PAPP,            'caps-06',                              null,                                 @nowplus1,                                 NULL,                                    'naps-06',                       @MPS,                          @nowplus2,                          @PK_MPS,                          'ps-06',             @PK_xx,             @nowplus3,               @PK_PDA,               5,                                @now),
  ('MGI:0000070',     'gene-070', 'c-07',        @PAPP,             @now,                   @PK_PAPP,            'caps-07',                              null,                                 @nowplus1,                                 NULL,                                    'naps-07',                       @MP,                           @nowplus2,                          @PK_MP,                           'ps-07',             @PK_xx,             @nowplus3,               @PK_MPDA,              6,                                @now),
  ('MGI:0000080',     'gene-080', 'c-08',        @PAPP,             @now,                   @PK_PAPP,            'caps-08',                              @MP,                                  @nowplus1,                                 @PK_MP,                                  'naps-08',                       @MPS,                          @nowplus2,                          @PK_MPS,                          'ps-08',             @PK_xx,             @nowplus3,               NULL,                  7,                                @now),
  ('MGI:0000090',     'gene-090', 'c-09',        @PAPP,             @now,                   @PK_PAPP,            'caps-09',                              @MPS,                                 @nowplus1,                                 @PK_MPS,                                 'naps-09',                       @MP,                           @nowplus2,                          @PK_MP,                           'ps-09',             @PK_xx,             @nowplus3,               NULL,                  8,                                @now),
  ('MGI:0000100',     'gene-100', 'c-10',        @PAPP,             @now,                   @PK_PAPP,            'caps-10',                              @MP,                                  @nowplus1,                                 @PK_MP,                                  'naps-10',                       @MPS,                          @nowplus2,                          @PK_MPS,                          'ps-10',             @PK_xx,             @nowplus3,               @PK_PDA,               9,                                @now),
  ('MGI:0000110',     'gene-110', 'c-11',        @PAPP,             @now,                   @PK_PAPP,            'caps-11',                              @MPS,                                 @nowplus1,                                 @PK_MPS,                                 'naps-11',                       @MP,                           @nowplus2,                          @PK_MP,                           'ps-11',             @PK_xx,             @nowplus3,               @PK_PDA,              10,                                @now),
  ('MGI:0000120',     'gene-120', 'c-12',        @PAPP,             @now,                   @PK_PAPP,            'caps-12',                              @MPS,                                 @nowplus1,                                 @PK_MPS,                                 'naps-12',                       @MP,                           @nowplus2,                          @PK_MP,                           'ps-12',             @PK_xx,             @nowplus3,               @PK_PDA,              11,                                @now)
;
