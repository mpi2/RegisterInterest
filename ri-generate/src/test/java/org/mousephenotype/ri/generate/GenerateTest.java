...
//        jdbc.getJdbcOperations().execute("CALL CSVWRITE('target/gene_sent1.csv', 'SELECT pk, address, mgi_accession_id, ri_assignment_status, ri_conditional_allele_production_status, ri_null_allele_production_status, ri_phenotyping_status, created_at, sent_at, updated_at, subject FROM gene_sent WHERE sent_at IS NULL', 'charset=UTF-8 fieldSeparator=,')");
//        //               body
