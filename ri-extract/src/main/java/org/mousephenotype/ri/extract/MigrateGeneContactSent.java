...
/**
 * This class implements the migration and extraction of the GeneContactSent report from iMits.
 *
 * Created by mrelac on 18/07/2017.
 */
...
//    private String sourceUrl = "https://www.i-dcc.org/dev/imits/v2/reports/mp2_load_gene_interest_report.tsv";
   ...
   private Map<String, ImitsStatus> imitsStatusMap;
    ...
    public void download() {
        ...
        {
            logger.warn(source + " -> " + target + "(" + dateUtils.msToHms(new Date().getTime() - start) + "). Reason: Bad URL: " + e.getLocalizedMessage());
        }
    ...
    @Transactional
    public void extract() throws InterestException {

        String line;
        String[] parts;
        Map<Integer, GeneSent> genesSent = sqlUtils.getGenesSent();
        List<GeneSent> geneSentList = new ArrayList<>();
        ...
        try {
            ...
            logger.warn("Open file '" + targetFilename + "' failed. Reason: " + e.getLocalizedMessage());
        }
    }
