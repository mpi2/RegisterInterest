...
include::generated-snippets/filtered-contact-get/curl-request.adoc[]
...
include::generated-snippets/filtered-contact-get/http-response.adoc[]
...
A `POST` request is used to register interest

==== Example request

include::generated-snippets/register/curl-request.adoc[]
...
A `DELETE` request is used to register interest

==== Example request

include::generated-snippets/unregister/curl-request.adoc[]
